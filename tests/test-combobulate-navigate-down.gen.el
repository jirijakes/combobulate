...
(ert-deftest
    combobulate-test-rust-combobulate-navigate-down--function-8 ()

  "Test `combobulate' with `fixtures/down/function.rs' in `rust-ts-mode' mode."
  (combobulate-test
      (:language rust :mode rust-ts-mode :fixture
		 "fixtures/down/function.rs")
    :tags '(combobulate rust rust-ts-mode combobulate-navigate-down)
    (combobulate-test-go-to-marker 1) (combobulate-navigate-down)
    (combobulate-test-assert-at-marker 2)
    (combobulate-test-go-to-marker 2) (combobulate-navigate-down)
    (combobulate-test-assert-at-marker 3)
...
(ert-deftest combobulate-test-rust-combobulate-navigate-down--impl-7
    ()

  "Test `combobulate' with `fixtures/down/impl.rs' in `rust-ts-mode' mode."
  (combobulate-test
      (:language rust :mode rust-ts-mode :fixture
		 "fixtures/down/impl.rs")
    :tags '(combobulate rust rust-ts-mode combobulate-navigate-down)
    (combobulate-test-go-to-marker 1) (combobulate-navigate-down)
    (combobulate-test-assert-at-marker 2)
    (combobulate-test-go-to-marker 2) (combobulate-navigate-down)
...
(ert-deftest combobulate-test-rust-combobulate-navigate-down--struct-4
    ()

  "Test `combobulate' with `fixtures/down/struct.rs' in `rust-ts-mode' mode."
  (combobulate-test
      (:language rust :mode rust-ts-mode :fixture
		 "fixtures/down/struct.rs")
    :tags '(combobulate rust rust-ts-mode combobulate-navigate-down)
    (combobulate-test-go-to-marker 1) (combobulate-navigate-down)
    (combobulate-test-assert-at-marker 2)
    (combobulate-test-go-to-marker 2) (combobulate-navigate-down)
